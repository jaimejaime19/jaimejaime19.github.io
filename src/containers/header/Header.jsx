  ...
  return (
    <div className='my__header section__padding' id="home">
        <div className='my__header-content'>
          ...
          <p> This website was made using ReactJS. Extensive use of HTML, CSS, and Javascript makes this site look excellent and mobile responsive! This website is hosted on Github Pages.</p>
